...
1. Increase skill and comfort with basic data management and syntax in R.
2. Review and increase understanding of the basic methodology and syntax of the for loop 
3. Simulating the sampling distributions for sample proportions and sample means.
4. Review the concepts of the sampling distribution and the normal approximation.
5. Practice constructing and interpreting confidence intervals.
...
Throughout the lab we will use the package `mosaic`. Make sure to load the `mosaic` package
